...
//    _timeLabel = [_bgView1 addLabelWithFrame:CGRectMake(40, 30, 70, 25) text:EGLocalizedString(@"GirdView_time_label", nil)];
//    //    _titleLabel = [bgView addLabelWithFrame:CGRectMake(40, 0, 150, 40) text:@"Elderly Community Care & Suport"];
//    _timeLabel.font = [UIFont boldSystemFontOfSize:12];
//    _timeLabel.textColor = [UIColor whiteColor];
    
//    _time = [_bgView1 addLabelWithFrame:CGRectMake(92,30, 120, 25) text:nil];
    ...
    _goalMoney.font = [UIFont systemFontOfSize:13];
    _goalMoney.textColor = [UIColor whiteColor];
    
    _button = [[MyBtn alloc] init];
    _button.frame = CGRectMake(ScreenSize.width-40, 18, 25, 25);
    [_button setBackgroundImage:[UIImage imageNamed:@"comment_poster_cart_nor@2x.png"] forState:UIControlStateNormal];
    [_button setBackgroundImage:[UIImage imageNamed:@"footer_cart_icon@2x.png"] forState:UIControlStateSelected];
//    [_bgView1 addSubview:_button];
}

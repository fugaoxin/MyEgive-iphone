...
- (void)prepare
{
    ...
    // 初始化文字
    //[self setTitle:EGLocalizedString(@"Loosenrefresh", nil) forState:MJRefreshStateIdle];
    [self setTitle:EGLocalizedString(@"drop-downrefresh", nil) forState:MJRefreshStatePulling];
    [self setTitle:EGLocalizedString(@"Loosenrefreshing", nil) forState:MJRefreshStateRefreshing];
}
